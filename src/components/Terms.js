...
const Terms = () => {
  return (
    <>
      ...
      <p>Welcome to World Affairs Conference!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of World Affairs Conference&apos;s Website, located at
        https://worldaffairs.ucc.on.ca.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use World Affairs Conference if you do
      ...
      <p>
        We employ the use of cookies. By accessing World Affairs Conference, you
        agreed to use cookies in agreement with the World Affairs
        Conference&apos;s Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, World Affairs Conference and/or its licensors
        own the intellectual property rights for all material on World Affairs
        Conference. All intellectual property rights are reserved. You may
        access this from World Affairs Conference for your own personal use
        subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from World Affairs Conference</li>
        <li>
          Sell, rent or sub-license material from World Affairs Conference
        </li>
        <li>
          Reproduce, duplicate or copy material from World Affairs Conference
        </li>
        <li>Redistribute content from World Affairs Conference</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. World
        Affairs Conference does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of World Affairs Conference,its agents and/or
        ...
        laws, World Affairs Conference shall not be liable for the Comments or
      ...
      <p>
        World Affairs Conference reserves the right to monitor all Comments and
      ...
      <p>
        You hereby grant World Affairs Conference a non-exclusive license to
      ...
      <p>
        ...
        the hyperlink compensates the absence of World Affairs Conference; and
      ...
      <p>
        ...
        e-mail to World Affairs Conference. Please include your name, your
      ...
      <p>
        No use of World Affairs Conference&apos;s logo or other artwork will be
