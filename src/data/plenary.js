...
const PlenaryJSON = [
  ...
  },
  {
    ...
    component: 'Plenary',
    props: {
      title: 'Serving the Global Community: Forward-Thinking',
      text: 'It takes the right people at the right time to deliver the right aid in this current economic environment. By exploring new opportunities, revamping existing ideas, and reimagining products to become more cost efficient, organizations need to constantly adapt to meet growing humanitarian needs. Join Rahul Singh, Founder and Executive Director of GlobalMedic, for a discussion on how the global pandemic, natural disasters, war, and recession and economic hardships have called for new thinking on how to effectively help the global community. ',
      speakers: [
        {
          name: 'Rahul Singh',
          img: RSINGH,
