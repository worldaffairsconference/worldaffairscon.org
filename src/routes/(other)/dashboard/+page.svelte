...
<section class="pt-[6rem] lg:pt-[9rem] pb-[5rem] lg:pb-[7rem]">
	<div
		class="max-w-screen-xl mx-auto px-6 lg:px-16 flex flex-col items-center"
	>
		...
		<div class="flex gap-5 w-3/4 mb-10">
			...
			<div class="flex flex-col items-start justify-center">
				...
				<p class="text-white sm:text-1xl text-left">
					...
					need some information about dietary restrictions, and
					financial information if you are coming outside of a school
					context.
				</p>
			</div>
		</div>
				...
				<AccordionItem header="Lunch Options" open>
					...
					>
						...
						>
							...
							<option value="false"
								>I will bring my own lunch</option
							>
						</Select>
						<Input
