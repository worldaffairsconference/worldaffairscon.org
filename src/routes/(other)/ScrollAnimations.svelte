<script lang="ts">
    ...
    onMount(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            // CHANGED: Split text timeline into About WAC (first) then Speakers
            ...
            // ADDED: About WAC appears, then fades out
            textTimeline
                .set("#aboutWac", { display: "block" })
                .fromTo(
                    "#aboutWac",
                    { opacity: 0, y: 20 },
                    { opacity: 1, y: 0, duration: 1.2 }
                )
                .to("#aboutWac", { opacity: 0, y: -10, duration: 0.8 })
                .set("#aboutWac", { display: "none" })

                // Speakers come in (original #stats logic kept but without hide)
                .set("#stats", { display: "block" })
                .fromTo(
                    "#stats",
                    { opacity: 0, y: 10 },
...
<div bind:this={gsapScope}>
    ...
    >
        <div
            ...
            id="container"
        >
            <!-- ADDED: About WAC overlay (first half of the text timeline) -->
            <div
                id="aboutWac"
            ...
            >
                <div class="flex h-full w-full items-center justify-center">
                    <div class="w-full max-w-4xl px-6">
                        <div class="mx-auto rounded-2xl bg-zinc-900/55 ring-1 ring-white/10 backdrop-blur p-6 md:p-8 text-zinc-200 leading-relaxed">
                            <h3 class="text-white text-2xl md:text-3xl font-bold mb-3 text-center">About WAC</h3>
                            <p class="mb-4">
                                Since 1983, WAC has been a place for high school students to listen, learn, and discuss a variety of topics ranging from STEM, education, social justice, sustainability and diversity &amp; inclusion. Through keynote speakers, plenary panels, as well as interactive sessions such as networking with the speakers themselves, students have the opportunity to hear directly from world renowned leaders as well as discuss ideas with their peers.
                            </p>
                            <p class="mb-4">
                                Led by a team of students from Upper Canada College and Branksome Hall, through many months of hard work WAC each year brings together an extraordinary roster of speakers to share their perspective on current topics affecting our society.
                            </p>
                            <p class="mb-1">
                                In the end WAC is more than just a conference, it's a space where innovative thinkers get to come together and engage in discussions with like minded individuals.
                            </p>
                        </div>
                    </div>
                </div>
