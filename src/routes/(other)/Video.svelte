<script lang="ts">
	...
	export let starVertices: number[];
	export let starsGeometry: BufferGeometry;
...
<section class="h-screen w-screen flex flex-col" id="videoSection">
	<h2
